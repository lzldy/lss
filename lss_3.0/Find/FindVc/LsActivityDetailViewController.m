...
-(void)loadBaseUI{
    ...
    [introduceBtn setImage:[UIImage imageNamed:@"details_button_before"] forState:UIControlStateNormal];
    ...
    [introduceBtn setTitleColor:[UIColor darkGrayColor] forState:UIControlStateNormal];
...
-(UIScrollView *)scrView{
    if (!_scrView) {
        ...
        _scrView.backgroundColor                  =[UIColor redColor];
    }
    return _scrView;
}
