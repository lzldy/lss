...
-(void)dealPPTViewDoubleTap {
    ...
    if (!self.isScreenLandScape) {
        ...
        [UIView animateWithDuration:0.25f animations:^{
            ...
            [ws.requestDataPlayBack setDocFrame:rect];
...
- (void)onParserQuestionArr:(NSArray *)questionArr onParserAnswerArr:(NSArray *)answerArr {
    ...
    for (NSDictionary *dic in questionArr) {
        ...
        if (arr == nil) {
            ...
            if([dic[@"isPublish"] integerValue] == 1) {
...
-(ChatView *)chatView {
    ...
    if(!_chatView) {
        ...
        ws.chatView.backgroundColor = CCRGBColor(250,250,250);;
    }
    return _chatView;
}
...
-(QuestionView *)questionChatView {
    ...
    if(!_questionChatView) {
        ...
        ws.questionChatView.backgroundColor = CCRGBColor(250,250,250);
    }
