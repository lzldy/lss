...
-(void)loginAction {
    ...
    parameter.userId =@"372FAB00A0958D2F";
    parameter.roomId =@"5E05459175ECD1329C33DC5901307461";
...
//    self.textFieldRoomId.text = @"34B1B80FF137A1089C33DC5901307461";
//    self.textFieldLiveId.text = @"AD763DE2B3C3EDA6";
