...
-(void)loadGuidePage{
    ...
    image1.image=[UIImage imageNamed:@"引导1"];
    ...
    image2.image=[UIImage imageNamed:@"引导2"];
    ...
    image3.image=[UIImage imageNamed:@"引导3"];
    ...
    //设置可滑动区域
    scroll.contentSize=CGSizeMake(CGRectGetMaxX(image4.frame), 0);
